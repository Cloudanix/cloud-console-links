...
def get_links() -> Dict:
    links = {
        ...
        "mediaconnect": {  # AWS Elemental MediaConnect
            ...
            "flow": 'https://{data.get("region", "")}.{data.get("console", "")}/mediaconnect/home?region={data.get("region", "")}#/flows/{data.get("resource", "")}',
            "output": None,  # sub-resource of flow, no direct deep-link
            "source": None,  # sub-resource of flow, no direct deep-link
        },
        "mediaconvert": {  # AWS Elemental MediaConvert
            "certificates": 'https://{data.get("region", "")}.{data.get("console", "")}/mediaconvert/home?region={data.get("region", "")}',
            "jobTemplates": 'https://{data.get("region", "")}.{data.get("console", "")}/mediaconvert/home?region={data.get("region", "")}#/job-templates/{data.get("resource", "")}',
            "jobs": 'https://{data.get("region", "")}.{data.get("console", "")}/mediaconvert/home?region={data.get("region", "")}#/jobs/{data.get("resource", "")}',
            "presets": 'https://{data.get("region", "")}.{data.get("console", "")}/mediaconvert/home?region={data.get("region", "")}#/presets/{data.get("resource", "")}',
            "queues": 'https://{data.get("region", "")}.{data.get("console", "")}/mediaconvert/home?region={data.get("region", "")}#/queues/{data.get("resource", "")}',
        },
        "medialive": {  # AWS Elemental MediaLive
            "channel": 'https://{data.get("region", "")}.{data.get("console", "")}/medialive/home?region={data.get("region", "")}#/channels/{data.get("resource", "")}',
            "input": 'https://{data.get("region", "")}.{data.get("console", "")}/medialive/home?region={data.get("region", "")}#/inputs/{data.get("resource", "")}',
            "inputDevice": 'https://{data.get("region", "")}.{data.get("console", "")}/medialive/home?region={data.get("region", "")}#/devices/{data.get("resource", "")}',
            "inputSecurityGroup": 'https://{data.get("region", "")}.{data.get("console", "")}/medialive/home?region={data.get("region", "")}#/security-groups/{data.get("resource", "")}',
            "multiplex": 'https://{data.get("region", "")}.{data.get("console", "")}/medialive/home?region={data.get("region", "")}#/multiplexes/{data.get("resource", "")}',
            "offering": 'https://{data.get("region", "")}.{data.get("console", "")}/medialive/home?region={data.get("region", "")}#/reservations',
            "reservation": 'https://{data.get("region", "")}.{data.get("console", "")}/medialive/home?region={data.get("region", "")}#/reservations/{data.get("resource", "")}',
        },
        "mediapackage": {  # AWS Elemental MediaPackage
            "channels": 'https://{data.get("region", "")}.{data.get("console", "")}/mediapackage/home?region={data.get("region", "")}#/channels/{data.get("resource", "")}',
            "origin_endpoints": 'https://{data.get("region", "")}.{data.get("console", "")}/mediapackage/home?region={data.get("region", "")}#/channels/{data.get("resource", "")}/endpoints',
        },
        "mediapackage-vod": {  # AWS Elemental MediaPackage VOD
            "assets": 'https://{data.get("region", "")}.{data.get("console", "")}/mediapackage/home?region={data.get("region", "")}#/assets',
            "packaging-configurations": 'https://{data.get("region", "")}.{data.get("console", "")}/mediapackage/home?region={data.get("region", "")}#/packaging-groups/{data.get("resource", "")}/packaging-configurations',
            "packaging-groups": 'https://{data.get("region", "")}.{data.get("console", "")}/mediapackage/home?region={data.get("region", "")}#/packaging-groups/{data.get("resource", "")}',
        },
        "mediastore": {  # AWS Elemental MediaStore
            "container": 'https://{data.get("region", "")}.{data.get("console", "")}/mediastore/home?region={data.get("region", "")}#/containers/{data.get("resource", "")}',
        },
