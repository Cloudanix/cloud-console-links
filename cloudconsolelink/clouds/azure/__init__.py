...
def get_azure_console_link(id: str, active_directory_name: str = None, iam_entity_type: str = None) -> str:
    if not active_directory_name and not iam_entity_type:
        logger.error("For IAM entity required `iam_entity_type` and for other entity required `active_directory_name`")
