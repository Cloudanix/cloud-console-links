...
class GCPLinker:
    def get_console_link(
        ...
        resources = {
            ...
            "cloud_scheduler_job": resource.cloud_scheduler_job,
            "cloud_tasks_queue": resource.cloud_tasks_queue,
            "cloud_spanner_instance": resource.cloud_spanner_instance,
            "cloud_spanner_database": resource.cloud_spanner_database,
            "artifact_registry_repository": resource.artifact_registry_repository,
            "secret_manager_secret": resource.secret_manager_secret,
            "memorystore_redis_instance": resource.memorystore_redis_instance,
            "memorystore_memcached_instance": resource.memorystore_memcached_instance,
            "cloud_nat_gateway": resource.cloud_nat_gateway,
            "cloud_router": resource.cloud_router,
            "vpn_tunnel": resource.vpn_tunnel,
            "vpn_gateway": resource.vpn_gateway,
            "vertex_ai_model": resource.vertex_ai_model,
            "vertex_ai_endpoint": resource.vertex_ai_endpoint,
            "vertex_ai_dataset": resource.vertex_ai_dataset,
            "workflows_workflow": resource.workflows_workflow,
            "eventarc_trigger": resource.eventarc_trigger,
            "alloydb_cluster": resource.alloydb_cluster,
            "alloydb_instance": resource.alloydb_instance,
            "cloud_filestore_instance": resource.cloud_filestore_instance,
            "target_http_proxy": resource.target_http_proxy,
            "target_https_proxy": resource.target_https_proxy,
            "url_map": resource.url_map,
            "network_endpoint_group": resource.network_endpoint_group,
            "target_pool": resource.target_pool,
            "interconnect_attachment": resource.interconnect_attachment,
            "cloud_deploy_pipeline": resource.cloud_deploy_pipeline,
            "cloud_ids_endpoint": resource.cloud_ids_endpoint,
            "dialogflow_agent": resource.dialogflow_agent,
            "cloud_endpoints_service": resource.cloud_endpoints_service,
        }
